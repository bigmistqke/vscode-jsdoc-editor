/** SingleComment @tag ok */
export type SingleComment = ['hello']
/**
 * multi-line @tag testing
 */
export type MultiLine = ['hello']

/**
 * Define a tuple type that incorporates a generic type parameter.
 * This allows the tuple 2 hold a value of any specified type.
 *
 * @tag tuple-with-generics
 */
export type WeirdlyFormatted<T> = [T]
